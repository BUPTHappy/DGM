...
class DiffActLossMLPUCGM(nn.Module):
    """Diffusion Loss with UCGM using MLP architecture"""
    ...
    def __init__(
        ...
        **kwargs
        ...
        print(f"DiffActLossMLPUCGM: num_sampling_steps: {num_sampling_steps}")
    ...
    def sample(self, z, temperature=1.0, cfg=1.0, text_latents=None):
        ...
        sampled_token = self.ucgmts.uni_sample(
                ...
                sampling_order=self.ucgmts_config.get("sampling_order", 1),
                time_dist_ctrl=self.ucgmts_config.get("time_dist_ctrl", [1.17, 0.8, 1.1]),
